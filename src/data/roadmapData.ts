...
const rawRoadmapData: Month[] = [
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        description: 'Test job shadowing assignment process - Due: July 25, 2025',
      ...
      },
      {
        ...
        description: 'Comprehensive testing of job shadowing process - Due: July 26, 2025',
      ...
      },
      {
        ...
        description: 'Test shift modification functionality - Due: July 27, 2025',
  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        priority: 'High',
        status: 'not-started',
        estimatedDate: 'September 18, 2025',
        userTypes: ['Promoters', 'Sales Reps', 'Admin']
      },
      {
        id: 'september-7',
        ...
        priority: 'Medium',
        status: 'not-started',
        estimatedDate: 'September 20, 2025',
        userTypes: ['Admin']
      },
      {
        id: 'september-8',
      ...
      },
      {
        ...
        priority: 'Medium',
        status: 'not-started',
        estimatedDate: 'September 25, 2025',
        userTypes: ['Promoters', 'Sales Reps', 'Admin'],
        examples: [
      ...
      },
      {
        ...
        priority: 'Low',
        status: 'not-started',
        estimatedDate: 'September 27, 2025',
        userTypes: ['Promoters']
      }
    ]
  },
